        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CoreCompetenciesSection_Title = table.Column<string>(type: "text", nullable: false),
                    CoreCompetenciesSection_Icon = table.Column<string>(type: "text", nullable: false),
                    CoreCompetenciesSection_DisplayAsChips = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GoogleGeminiApiKey = table.Column<string>(type: "text", nullable: true),
                    ...
                    OpenRouterApiKey = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GeneratedApplications", x => x.Id);
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GeneratedApplications_JobPostings_JobPostingId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Interests_CandidateProfiles_CandidateProfileId",
                        column: x => x.CandidateProfileId,
                        principalTable: "CandidateProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GeneratedApplications_CandidateProfileId",
                table: "GeneratedApplications",
                column: "CandidateProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_GeneratedApplications_JobPostingId",
                table: "GeneratedApplications",
                column: "JobPostingId");

            migrationBuilder.CreateIndex(
                name: "IX_GeneratedApplications_UserId",
                table: "GeneratedApplications",
                column: "UserId");

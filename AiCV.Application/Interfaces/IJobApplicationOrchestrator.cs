namespace AiCV.Application.Interfaces
{
    public interface IJobApplicationOrchestrator
    {
        ...
        Task<(string CoverLetter, TailoredResumeResult ResumeResult)> GenerateApplicationAsync(string userId, AIProvider provider, CandidateProfile profile, JobPosting job, AIModel? model = null, string? customPrompt = null);
